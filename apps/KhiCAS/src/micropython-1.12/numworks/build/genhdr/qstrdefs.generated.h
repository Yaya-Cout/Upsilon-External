...
QDEF(MP_QSTR_begin_fill, (const byte*)"\x52\x5b\x0a" "begin_fill")
...
QDEF(MP_QSTR_end_fill, (const byte*)"\xda\xab\x08" "end_fill")
...
QDEF(MP_QSTR_towards, (const byte*)"\xcd\x98\x07" "towards")
